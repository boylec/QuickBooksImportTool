...
//            return Program.CurrentBillPayments.Find(x => x.CreatedDate == optionalDate && x.VendorId == vendorId && x.TotalAmount == amount);
//        }
...
//        {
//            baseRequest.DocNumber = billPaymentItem.ParentRow["Num"].ToString();
//            baseRequest.PaymentDate = DateTime.Parse(billPaymentItem.ParentRow["Date"].ToString());
...
//        {
//            return detailRow["Account"].ToString() != parentRowForDetail["Account"].ToString();
//        }
//    }
//}
